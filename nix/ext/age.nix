...
let
  ...
  _ = lib.asserts.assertMsg (supportedVersions != { }) ''
    Apache AGE is only packaged in this repo for standard PostgreSQL 15 and 17.
    It is not supported for ${postgresql.version}, including the OrioleDB variant.
  '';
    ...
    stdenv.mkDerivation rec {
      ...
      installPhase = ''
        ...
        if [[ "${version}" == "${latestVersion}" ]]; then
          ...
          ln -sfn ../${pname}${postgresql.dlSuffix} $out/lib/plugins/${pname}${postgresql.dlSuffix}
        fi
